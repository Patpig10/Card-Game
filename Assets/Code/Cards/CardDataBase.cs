...
public class CardDataBase : MonoBehaviour
{
    ...
    void Awake()
    {
        ...
        cardList.Add(new Card(1, "Morbol Jr", 1, 30, "A beast that has a strong bite", Resources.Load < Sprite>("morbol jr"), "White",0,0,0,0,0, false, 0, false,0, 0, 0, false, false, false,0,false,false));
        cardList.Add(new Card(2, "Morbol King", 5, 50, "Devour those who are unlucky to meet it", Resources.Load < Sprite>("Morbol King"), "White", 0,0,0,0,0, false, 0, false,0, 0, 0, false, false, false,0,false,false));
        cardList.Add(new Card(3, "Liz", 3, 20, "Draw 1", Resources.Load < Sprite>("4"), "White", 1, 0,0,0,0,false,0, false,0, 0, 0, false, false, false,0, false, false));
        cardList.Add(new Card(4, "Kris", 4, 30, "From Grave To hand", Resources.Load < Sprite>("5"), "White", 0, 2,1,0,0, false, 0, false,0, 0, 0, false, false, false, 0, false,false));

      

        //spells
        cardList.Add(new Card(5, "Holy Light", 6, 0, "Spell Card damage 300", Resources.Load<Sprite>("Heal"), "Black", 0, 0, 0, 0, 0, true, 300, false,0, 0, 0, false, false, false,0,false,false));
      cardList.Add(new Card(6, "Luci2", 3, 0, "revive", Resources.Load<Sprite>("3"), "Blue", 0, 0, 0, 0, 0, true, 0, false, 1, 0, 0, false, false, false, 0, false, false));
       cardList.Add(new Card(7, "Liz2", 3, 0, "Heal spell", Resources.Load<Sprite>("Heal"), "Green", 0, 0, 0, 500, 0, true, 0, false, 0, 0, 0, false, false, false,0, false,false));
     cardList.Add(new Card(8, "Kris2", 2, 0, "Draw 2", Resources.Load<Sprite>("5"), "Blue", 2, 0, 0, 0, 0, true, 0, false,0, 0, 0, false, false, false,0, false, false));
